    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Dalimss News</h1>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleCredentialsLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#ff6d00] hover:bg-[#e65100] text-white font-bold py-3 rounded-lg transition-colors disabled:opacity-50"
            >
        ...
        {/* Footer */}
        <p className="mt-6 text-center text-xs text-gray-500">
          © 2026 Dalimss News. All rights reserved.
        </p>
      </div>
    </div>
  );
